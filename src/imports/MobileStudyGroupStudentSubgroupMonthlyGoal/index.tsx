import svgPaths from "./svg-7oeuhb2zbb";
import { imgInfo } from "./svg-w8iw2";
...
export default function MobileStudyGroupStudentSubgroupMonthlyGoal() {
  return (
    <div className="bg-white relative size-full" data-name="Mobile/Study Group / Student / Subgroup / Monthly goal">
      <HeaderContainer />
      <Container />
      <JobHeaderCard />
    </div>
