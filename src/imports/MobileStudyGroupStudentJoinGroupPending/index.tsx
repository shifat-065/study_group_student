import svgPaths from "./svg-zdm1qaheve";
import imgGroupImage from "./6f2aba55d4a40244fc9e8910ff07f4bd4f53f07a.png";
import { imgSchedule, imgInfo } from "./svg-2pbqb";
...
function TitleContainer() {
  return (
    <div className="content-stretch flex h-[24px] items-center relative shrink-0 w-full" data-name="Title Container">
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="error">
      <svg className="absolute block inset-0 size-full" fill="none" height="18" preserveAspectRatio="none" viewBox="0 0 18 18" width="18">
        <g id="error">
          <mask height="18" id="mask0_0_211" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="18" x="0" y="0">
...
function MetadataContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 w-full" data-name="Metadata Container">
      <StatusContainer />
      <GroupAdmin />
    </div>
  );
...
function DetailsContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-w-px relative" data-name="Details Container">
      <TitleContainer />
      <MetadataContainer />
      <GroupSummary />
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[10px] relative shrink-0" data-name="State-layer">
      <div className="relative shrink-0 size-[20px]" data-name="clock">
        <div className="absolute inset-[10.42%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-2.5px] mask-size-[24px_24px]" style={{ maskImage: `url("${imgSchedule}")` }} data-name="schedule">
          <svg className="absolute block inset-0 size-full" fill="none" height="15.8333" preserveAspectRatio="none" viewBox="0 0 15.8333 15.8333" width="15.8333">
            <path d={svgPaths.p24e86080} fill="#930000" id="schedule" />
          </svg>
        </div>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Noto_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#930000] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100' }}>
...
function Content() {
  return (
    <div className="bg-[#ffdad6] content-stretch flex flex-[1_0_0] flex-col items-center justify-center min-w-px overflow-clip relative rounded-[100px]" data-name="Content">
      <StateLayer />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[10px] relative shrink-0" data-name="State-layer">
      <div className="relative shrink-0 size-[20px]" data-name="error">
        <div className="absolute inset-[10.42%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-2.5px] mask-size-[24px_24px]" style={{ maskImage: `url("${imgSchedule}")` }} data-name="error">
          <svg className="absolute block inset-0 size-full" fill="none" height="15.8333" preserveAspectRatio="none" viewBox="0 0 15.8333 15.8333" width="15.8333">
...
export default function MobileStudyGroupStudentJoinGroupPending() {
  return (
    <div className="bg-white relative size-full" data-name="Mobile/Study Group / Student / Join Group - Pending">
      <Container />
      <JobHeaderCard />
    </div>
  );
